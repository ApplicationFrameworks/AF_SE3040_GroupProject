        ...
        {document.map((Document, key) => (
          <div key={key}>
              <div className="p-3" style={{overflowX:'auto'}}>
                ...
                <td className='tableData' style={{width:1100}}>{Document.details}</td>
               
                <td style={{width:120}}>

                  <IconButton>
                    <PictureAsPdfIcon style={{ color: red[800], backgroundPosition: 'center' }} ></PictureAsPdfIcon>
                  </IconButton>
                </td>
<td>
                  <span>
                    <MoreHorizIcon style={{ color: blue[900] ,cursor:'pointer'}} onClick={() => view(Document._id)}/>
                  </span>
                  </td>
                  </tr>
                </tbody>
