...
exports.studentsignup = async(req,res) => {
    const {firstname, lastname, email, itNo, phone, password, imgUrl} = req.body;
    ...
    try {
        ...
        const student = await Student.create({firstname, lastname, email, itNo, phone, password, imgUrl});
